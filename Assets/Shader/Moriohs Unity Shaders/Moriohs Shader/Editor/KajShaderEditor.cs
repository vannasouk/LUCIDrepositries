...
namespace MoriohsShader
{
    ...
    //FoldoutTest
    public class ShaderVersion : MaterialPropertyDrawer
    {
        public string ver = "<color=#ffffffff> ✿ {  </color>Moriohs Shader v" + "<color=#ff0000ff> 1.0.0</color>" + "<color=#000000ff>  } ✿ </color>";
